    ...
    <section className="pt-10 sm:pt-20 lg:pt-32 pb-5 sm:pb-16 md:pb-20 lg:pb-24 relative z-[5]" id='projects'>
      ...
      <div className="container">
        <div className="text-center relative z-10 mb-10 sm:mb-14 lg:mb-20">
          <div className="heading absolute select-none font-black opacity-30 -top-[20%] md:-top-[30%] lg:-top-[50%] left-1/2 -translate-x-1/2 uppercase text-[80px] md:text-[120px] lg:text-[170px] -z-10 tracking-wider bg-gradient-to-t from-[#05050900] to-[#262d49] bg-clip-text text-transparent">
            WORKS
          </div>
